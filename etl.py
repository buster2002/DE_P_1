...
# process_song_file uses to read the list of Song's JOSN files and INSERT into Tables
...
# process_log_file uses to read the list of log's JOSN files and INSERT into Tables
...
# process_data uses to get the list of log's & song's JOSN files
